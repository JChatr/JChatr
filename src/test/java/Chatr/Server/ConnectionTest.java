...
//		Chat c = Chat.newChat(u1, new User("createIdenticalConversations2"));
...
//		Set<Chat> chats = null;
//		try {
//			Chat c1 = Chat.newChat(u1, new User("b"));
//			Thread.sleep(2);
//			Chat c2 = Chat.newChat(u1, new User("b"));
//			Thread.sleep(2);
//			Chat c3 = Chat.newChat(u1, new User("b"));
...
//		Chat c = Chat.newChat(u1, u2);
//
//		Connection.createConversation(c.getID().get(), c.getMemberIDs());
//		boolean deleted = Connection.deleteChat(c.getID().get());
//
//		assertTrue(deleted);
...
//		c.addMember(u3);
//		c.addMember(u4);
//		boolean updated = Connection.updateChatUsers(c.getID().get(), c.getMemberIDs());
//
//		assertTrue(updated);
...
//		Chat c = Chat.newChat(u1, new User("readNewMessagesValid"));
