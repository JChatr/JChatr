...
public class Chat {
    ...
    public Message newMessage(String content, ContentType contentType, int width, int height, Image gifImg) {
        Message message = new Message(localUser, content, contentType, width, height, gifImg);
        messages.add(message);
        Connection.addMessage(conversationID.get(), message);
        return message;
    }
