...
public class Manager {
    ...
    public static Message addMessage(String content, ContentType contentType, int width, int height, Image gifImg) {
        return currentChat.get().newMessage(content, contentType, width, height, gifImg);
    }
